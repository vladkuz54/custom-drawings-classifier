...
class DrawingClassifier:
    ...
    def classes_prompt(self):
        ...
        self.proj_name = simpledialog.askstring('Project Name', 'Enter project name:')
    ...
    def init_gui(self):
        ...
        bm_btn = Button(btn_frame, text='Brush+', command=self.brushplus)
    ...
    def clear(self):
        ...
        self.draw.rectangle((0, 0, 1000, 1000), fill=(255, 255, 255))
    ...
    def predict(self):
        ...
        if prediction[0] == 1:
            tkinter.messagebox.showinfo('Prediction', f'The drawing is a {self.class1}!', parent=self.root)
        elif prediction[0] == 2:
    ...
    def on_closing(self):
        answer = tkinter.messagebox.askyesnocancel('Quit', 'Do you want to save everything before quitting?', parent=self.root)
